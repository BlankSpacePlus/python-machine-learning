...
原Repository遗址：[这里](../../../machine_learning_python_codes)

因为venv的问题，随着依赖库的增多，不得不剔除这些库，只提交code到Github上。因为操作问题和网速问题导致重建项目，tcl，……

文本处理的Repository遗址：[这里](../../../python-text-processing-learning)

图像处理的Repository遗址：[这里](../../../python-image-processing-learning)
